...
<section id="banner">
    ...
    <div class="wrap-login100 p-l-50 p-r-50 p-t-50 p-b-33" style="margin-top: 60px;width: 480px;">
        <form class="login100-form validate-form flex-sb flex-w" action="../../../../controllers/admin/condominio/register-condominio/register-condominio.php" method="POST">
            ...
            <div class="wrap-input100 validate-input" data-validate="Nombre Condominio is required">
                <input class="input100" type="text" name="nombre_condominio" style="color:black;">
            ...
            <div class="wrap-input100 validate-input" data-validate="Alias is required">
                <input class="input100" type="text" name="alias" style="color:black;">
                <span class="focus-input100"></span>
            </div>
            ...
            <div class="p-t-25 p-b-9">
             ...
             <label class="switch">
                <input type="checkbox" checked class="form-control" name="activo">
